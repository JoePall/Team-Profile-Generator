...
const renderManager = manager => {
  let template = renderEmployee(manager, template, "Manager.html");
...
const renderEngineer = engineer => {
  let template = renderEmployee(manager, template, "Engineer.html");
...
const renderIntern = intern => {
  let template = renderEmployee(manager, template, "Intern.html");
...
const renderEmployee = (employee, template, fileName) => {
